<template>
	<view class="detail-container">
		<view class="video">
			<video id="myVideo" :show-fullscreen-btn='true' :show-play-btn='false' :enable-progress-gesture='false' objectFit="fill"
			 :src="pullSrc">
				<!-- 用户观看人数以及红包 -->
				...
				<view class="sign-container" v-if="showSignIn">
					<view class="modal-sign">
						<!-- <cover-image class="sign-img" :src="qiandao"></cover-image> -->
		...
		<view v-if='showOpenWallModal' class="my-modal">
			<view class="no-wallet">
				...
				<image @click="showOpenWallModal = false" class="close-btn" src="../../static/close-btn.png" mode="aspectFill"></image>
			</view>
		</view>
		<!-- 用户签到蒙层 -->
